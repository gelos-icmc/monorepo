...
- GELOS 3:
  - Problemas com os posicionamentos, mesmo que não os comportelegram.mentos
...
- GELOS 1:
  ...
  - Não queremos ver até onde vai o comportelegram.mento dele
- GELOS 1 e 2:
...
### Encaminhamentos
  ...
  2. A volta dele não pode acontecer se não tiver uma mudança positiva em sua posicionamento/comportelegram.mento (conforme exposto anteriormente).
