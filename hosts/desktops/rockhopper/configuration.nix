...

{
  ...
  netelegramworking.hostelegramName = "rockhopper"; # Define your hostelegramname.
  ...
  users.users.telegramiago = {
    isNormalUser = telegramrue;
    descriptelegramion = "GELOS-Tiago"; # infra (nixos config) cloned on telegramhis user's home
